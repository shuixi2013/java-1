...
public class RandomUtilsTest {
    ...
    public void testZeroLengthNextBytes() {
        Assert.assertArrayEquals(new byte[0], RandomUtils.nextBytes(0));
    }
    ...
    public void testNextIntMinimalRange() {
        Assert.assertEquals(42, RandomUtils.nextInt(42, 42));
    }
    ...
    public void testNextInt() {
        ...
        Assert.assertTrue(result >= 33 && result < 42);
    }
    ...
    public void testNextIntRandomResult() {
        ...
        Assert.assertTrue(randomResult > 0);
        Assert.assertTrue(randomResult < Integer.MAX_VALUE);
    }
    ...
    public void testNextDoubleMinimalRange() {
        Assert.assertEquals(42.1, RandomUtils.nextDouble(42.1, 42.1), DELTA);
    }    
    ...
    public void testNextFloatMinimalRange() {
        Assert.assertEquals(42.1f, RandomUtils.nextFloat(42.1f, 42.1f), DELTA);
    }     
    ...
    public void testNextDouble() {
        ...
        Assert.assertTrue(result >= 33d && result <= 42d);
    }
    ...
    public void testNextDoubleRandomResult() {
        ...
        Assert.assertTrue(randomResult > 0);
        Assert.assertTrue(randomResult < Double.MAX_VALUE);
    }
    ...
    public void testNextFloat() {
        ...
        Assert.assertTrue(result >= 33f && result <= 42f);
    }
    ...
    public void testNextFloatRandomResult() {
        ...
        Assert.assertTrue(randomResult > 0);
        Assert.assertTrue(randomResult < Float.MAX_VALUE);
    }
    ...
    public void testNextLongMinimalRange() {
        Assert.assertEquals(42L, RandomUtils.nextLong(42L, 42L));
    }
    ...
    public void testNextLong() {
        ...
        Assert.assertTrue(result >= 33L && result < 42L);
    }
    ...
    public void testNextLongRandomResult() {
        ...
        Assert.assertTrue(randomResult > 0);
        Assert.assertTrue(randomResult < Long.MAX_VALUE);
    }
    ...
    public void testExtremeRangeLong() {
        ...
        Assert.assertTrue(result >= 0 && result < Long.MAX_VALUE);
    }    
    ...
    public void testExtremeRangeFloat() {
        ...
        Assert.assertTrue(result >= 0f && result <= Float.MAX_VALUE);
    }    
    ...
    public void testExtremeRangeDouble() {
        ...
        Assert.assertTrue(result >= 0 && result <= Double.MAX_VALUE);
    }    
}
