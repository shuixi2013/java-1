...
public class RandomStringUtilsTest {
    ...
    public void testRandomStringUtils() {
        ...
        Assert.assertEquals("random(50) length", 50, r1.length());
        String r2 = RandomStringUtils.random(50);
        Assert.assertEquals("random(50) length", 50, r2.length());
        Assert.assertTrue("!r1.equals(r2)", !r1.equals(r2));
        
        r1 = RandomStringUtils.randomAscii(50);
        Assert.assertEquals("randomAscii(50) length", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("char between 32 and 127", r1.charAt(i) >= 32 && r1.charAt(i) <= 127);
        }        
        r2 = RandomStringUtils.randomAscii(50);
        Assert.assertTrue("!r1.equals(r2)", !r1.equals(r2));

        r1 = RandomStringUtils.randomAlphabetic(50);
        Assert.assertEquals("randomAlphabetic(50)", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("r1 contains alphabetic", Character.isLetter(r1.charAt(i)) && !Character.isDigit(r1.charAt(i)));
        }
        r2 = RandomStringUtils.randomAlphabetic(50);
        Assert.assertTrue("!r1.equals(r2)", !r1.equals(r2));
        
        r1 = RandomStringUtils.randomAlphanumeric(50);
        Assert.assertEquals("randomAlphanumeric(50)", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("r1 contains alphanumeric", Character.isLetterOrDigit(r1.charAt(i)));
        }
        r2 = RandomStringUtils.randomAlphabetic(50);
        Assert.assertTrue("!r1.equals(r2)", !r1.equals(r2));
        
        r1 = RandomStringUtils.randomGraph(50);
        Assert.assertEquals("randomGraph(50) length", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("char between 33 and 126", r1.charAt(i) >= 33 && r1.charAt(i) <= 126);
        }
        r2 = RandomStringUtils.randomGraph(50);
        Assert.assertTrue("!r1.equals(r2)", !r1.equals(r2));
        
        r1 = RandomStringUtils.randomNumeric(50);
        Assert.assertEquals("randomNumeric(50)", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("r1 contains numeric", Character.isDigit(r1.charAt(i)) && !Character.isLetter(r1.charAt(i)));
        }
        r2 = RandomStringUtils.randomNumeric(50);
        Assert.assertTrue("!r1.equals(r2)", !r1.equals(r2));
        
        r1 = RandomStringUtils.randomPrint(50);
        Assert.assertEquals("randomPrint(50) length", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("char between 32 and 126", r1.charAt(i) >= 32 && r1.charAt(i) <= 126);
        }
        ...
        Assert.assertEquals("random(50, \"abcdefg\")", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("random char in set", set.indexOf(r1.charAt(i)) > -1);
        }
        ...
        Assert.assertEquals("random(50, \"stuvwxyz\")", 50, r1.length());
        for(int i = 0; i < r1.length(); i++) {
            Assert.assertTrue("random char in set", set.indexOf(r1.charAt(i)) > -1);
        }
        r2 = RandomStringUtils.random(50, set);
        ...
        Assert.assertEquals("r1.equals(r2)", r1, r2);

        r1 = RandomStringUtils.random(0);
        Assert.assertEquals("random(0).equals(\"\")", "", r1);
    }

    @Test
    public void testLANG805() {
        final long seed = System.currentTimeMillis();
        Assert.assertEquals("aaa", RandomStringUtils.random(3,0,0,false,false,new char[]{'a'},new Random(seed)));
    }
    ...
    public void testLANG807() {
        try {
            ...
            Assert.assertTrue("Message (" + msg + ") must contain 'start'", msg.contains("start"));
            Assert.assertTrue("Message (" + msg + ") must contain 'end'", msg.contains("end"));
        }
    }
    ...
    public void testRandomAlphaNumeric() {
        ...
        for (int i = 0; i < testChars.length; i++) {
            if (!found[i]) {
                Assert.fail("alphanumeric character not generated in 1000 attempts: "
    ...
    public void testRandomNumeric() {
        ...
        for (int i = 0; i < testChars.length; i++) {
            if (!found[i]) {
                Assert.fail("digit not generated in 1000 attempts: "
                   + testChars[i] +" -- repeated failures indicate a problem ");
            }
        }  
    }
    ...
    public void testRandomAscii() {
        ...
        for (int i = 0; i < testChars.length; i++) {
            if (!found[i]) {
                Assert.fail("ascii character not generated in 1000 attempts: "
                + (int) testChars[i] + 
    ...
    public void testRandomAsciiRange() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            Assert.assertThat("within range", s.length(), allOf(greaterThanOrEqualTo(expectedMinLengthInclusive), lessThanOrEqualTo(expectedMaxLengthExclusive - 1)));
            Assert.assertTrue(s, s.matches(pattern));
        ...
        Assert.assertThat("min generated, may fail randomly rarely", minCreatedLength, is(expectedMinLengthInclusive));
        Assert.assertThat("max generated, may fail randomly rarely", maxCreatedLength, is(expectedMaxLengthExclusive - 1));
    }
    ...
    public void testRandomStringUtilsHomog() {
        ...
        Assert.assertTrue("test homogeneity -- will fail about 1 in 1000 times",
    ...
    public void testLang100() {
        ...
        for (int i=0; i < orig.length() && i < copy.length(); i++) {
            ...
            Assert.assertEquals("differs at " + i + "(" + Integer.toHexString(new Character(o).hashCode()) + "," +
            Integer.toHexString(new Character(c).hashCode()) + ")", o, c);
        }
        // compare length also
        Assert.assertEquals(orig.length(), copy.length());
        // just to be complete
