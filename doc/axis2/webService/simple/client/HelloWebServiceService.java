 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://server.simple.webService.by.com/", wsdlLocation = "http://localhost:9998/helloWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://server.simple.webService.by.com/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9998/helloWebService?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://server.simple.webService.by.com/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.simple.webService.by.com/", "HelloWebServicePort"), HelloWebService.class, features);
    }
