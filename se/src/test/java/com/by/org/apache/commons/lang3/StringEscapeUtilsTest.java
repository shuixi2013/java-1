...
public class StringEscapeUtilsTest {
    ...
    public void testEscapeJava() throws IOException {
        Assert.assertEquals(null, StringEscapeUtils.escapeJava(null));
        try {
    ...
    public void testUnescapeJava() throws IOException {
        Assert.assertEquals(null, StringEscapeUtils.unescapeJava(null));
        try {
    ...
    private void assertUnescapeJava(final String message, final String unescaped, final String original) throws IOException {
        ...
        Assert.assertEquals("unescape(String) failed" +
    ...
    public void testEscapeEcmaScript() {
        Assert.assertEquals(null, StringEscapeUtils.escapeEcmaScript(null));
        try {
        ...
        Assert.assertEquals("document.getElementById(\\\"test\\\").value = \\'<script>alert(\\'aaa\\');<\\/script>\\';",
    ...
    public void testEscapeHtml() {
        for (final String[] element : HTML_ESCAPES) {
            ...
            Assert.assertEquals(message, expected, StringEscapeUtils.escapeHtml4(original));
    ...
    public void testUnescapeHtml4() {
        for (final String[] element : HTML_ESCAPES) {
            ...
            Assert.assertEquals(message, expected, StringEscapeUtils.unescapeHtml4(original));
    ...
    public void testUnescapeHexCharsHtml() {
        ...
        for (char i = Character.MIN_VALUE; i < Character.MAX_VALUE; i++) {
            ...
            Assert.assertEquals("hex number unescape index " + (int)i, expected, StringEscapeUtils.unescapeHtml4(escapedC1 + escapedC2));
        }
    }
    ...
    public void testEscapeXml() throws Exception {
        ...
        Assert.assertEquals("XML should not escape >0x7f values",
                "\u00A1", StringEscapeUtils.escapeXml("\u00A1"));
        Assert.assertEquals("XML should be able to unescape >0x7f values",
                "\u00A0", StringEscapeUtils.unescapeXml("&#160;"));
        Assert.assertEquals("XML should be able to unescape >0x7f values with one leading 0",
                "\u00A0", StringEscapeUtils.unescapeXml("&#0160;"));
        Assert.assertEquals("XML should be able to unescape >0x7f values with two leading 0s",
                "\u00A0", StringEscapeUtils.unescapeXml("&#00160;"));
        Assert.assertEquals("XML should be able to unescape >0x7f values with three leading 0s",
                "\u00A0", StringEscapeUtils.unescapeXml("&#000160;"));
        ...
        Assert.assertEquals(null, StringEscapeUtils.escapeXml(null));
        Assert.assertEquals(null, StringEscapeUtils.unescapeXml(null));
        ...
        Assert.assertEquals("XML was escaped incorrectly", "&lt;abc&gt;", sw.toString() );
        ...
        Assert.assertEquals("XML was unescaped incorrectly", "<abc>", sw.toString() );
    }
    ...
    public void testEscapeXml10() throws Exception {
        ...
        Assert.assertEquals("XML 1.0 should omit most #x0-x8 | #xb | #xc | #xe-#x19",
                "ab", StringEscapeUtils.escapeXml10("a\u0000\u0001\u0008\u000b\u000c\u000e\u001fb"));
        Assert.assertEquals("XML 1.0 should omit #xd800-#xdfff",
                "a\ud7ff  \ue000b", StringEscapeUtils.escapeXml10("a\ud7ff\ud800 \udfff \ue000b"));
        Assert.assertEquals("XML 1.0 should omit #xfffe | #xffff",
                "a\ufffdb", StringEscapeUtils.escapeXml10("a\ufffd\ufffe\uffffb"));
        Assert.assertEquals("XML 1.0 should escape #x7f-#x84 | #x86 - #x9f, for XML 1.1 compatibility",
                "a\u007e&#127;&#132;\u0085&#134;&#159;\u00a0b", StringEscapeUtils.escapeXml10("a\u007e\u007f\u0084\u0085\u0086\u009f\u00a0b"));
    }
    ...
    public void testEscapeXml11() throws Exception {
        ...
        Assert.assertEquals("XML 1.1 should omit #x0",
                "ab", StringEscapeUtils.escapeXml11("a\u0000b"));
        Assert.assertEquals("XML 1.1 should escape #x1-x8 | #xb | #xc | #xe-#x19",
                "a&#1;&#8;&#11;&#12;&#14;&#31;b", StringEscapeUtils.escapeXml11("a\u0001\u0008\u000b\u000c\u000e\u001fb"));
        Assert.assertEquals("XML 1.1 should escape #x7F-#x84 | #x86-#x9F",
                "a\u007e&#127;&#132;\u0085&#134;&#159;\u00a0b", StringEscapeUtils.escapeXml11("a\u007e\u007f\u0084\u0085\u0086\u009f\u00a0b"));
        Assert.assertEquals("XML 1.1 should omit #xd800-#xdfff",
                "a\ud7ff  \ue000b", StringEscapeUtils.escapeXml11("a\ud7ff\ud800 \udfff \ue000b"));
        Assert.assertEquals("XML 1.1 should omit #xfffe | #xffff",
                "a\ufffdb", StringEscapeUtils.escapeXml11("a\ufffd\ufffe\uffffb"));
    }
    ...
    public void testEscapeXmlSupplementaryCharacters() {
        ...
        Assert.assertEquals("Supplementary character must be represented using a single escape", "&#144308;",
                escapeXml.translate("\uD84C\uDFB4"));

        Assert.assertEquals("Supplementary characters mixed with basic characters should be encoded correctly", "a b c &#144308;",
    ...
    public void testEscapeXmlAllCharacters() {
        ...
        Assert.assertEquals("&#0;&#1;&#2;&#3;&#4;&#5;&#6;&#7;&#8;", escapeXml.translate("\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\u0008"));
        Assert.assertEquals("\t", escapeXml.translate("\t")); // 0x9
        Assert.assertEquals("\n", escapeXml.translate("\n")); // 0xA
        Assert.assertEquals("&#11;&#12;", escapeXml.translate("\u000B\u000C"));
        Assert.assertEquals("\r", escapeXml.translate("\r")); // 0xD
        Assert.assertEquals("Hello World! Ain&apos;t this great?", escapeXml.translate("Hello World! Ain't this great?"));
        Assert.assertEquals("&#14;&#15;&#24;&#25;", escapeXml.translate("\u000E\u000F\u0018\u0019"));
    }
    ...
    public void testUnescapeXmlSupplementaryCharacters() {
        ...
        Assert.assertEquals("Supplementary characters mixed with basic characters should be decoded correctly", "a b c \uD84C\uDFB4",
    ...
    public void testEscapeCsvString() throws Exception {
        ...
        Assert.assertEquals("\"foo\"\"bar\"",     StringEscapeUtils.escapeCsv("foo\"bar"));
        Assert.assertEquals("foo\uD84C\uDFB4bar", StringEscapeUtils.escapeCsv("foo\uD84C\uDFB4bar"));
        Assert.assertEquals("",   StringEscapeUtils.escapeCsv(""));
        Assert.assertEquals(null, StringEscapeUtils.escapeCsv(null));
    }
    ...
    public void testUnescapeCsvString() throws Exception {
        ...
        Assert.assertEquals("foo\"bar",             StringEscapeUtils.unescapeCsv("\"foo\"\"bar\""));
        Assert.assertEquals("foo\uD84C\uDFB4bar",   StringEscapeUtils.unescapeCsv("foo\uD84C\uDFB4bar"));
        Assert.assertEquals("",   StringEscapeUtils.unescapeCsv(""));
        Assert.assertEquals(null, StringEscapeUtils.unescapeCsv(null));
    ...
    public void testEscapeHtmlHighUnicode() {
        ...
        Assert.assertEquals( "High Unicode should not have been escaped", original, escaped);

        final String unescaped = StringEscapeUtils.unescapeHtml4( escaped );
        Assert.assertEquals( "High Unicode should have been unchanged", original, unescaped);
...
//        assertEquals( "High Unicode should have been unescaped", original, unescapedFromEntity);
    ...
    public void testEscapeHiragana() {
        ...
        final String escaped = StringEscapeUtils.escapeHtml4(original);
        Assert.assertEquals( "Hiragana character Unicode behaviour should not be being escaped by escapeHtml4",
        original, escaped);

        final String unescaped = StringEscapeUtils.unescapeHtml4( escaped );

        Assert.assertEquals( "Hiragana character Unicode behaviour has changed - expected no unescaping", escaped, unescaped);
    }
    ...
    public void testLang708() throws IOException {
        ...
        // just the end:
        Assert.assertTrue(escaped, escaped.endsWith("}]"));
        // a little more:
        Assert.assertTrue(escaped, escaped.endsWith("\"valueCode\\\":\\\"\\\"}]"));
        fis.close();
    }
    ...
    public void testLang911() {
        ...
        Assert.assertEquals(bellsTest, valueTest);
    }

    @Test
    public void testEscapeJson() {
        Assert.assertEquals(null, StringEscapeUtils.escapeJson(null));
        try {
        ...
        Assert.assertEquals(expected, StringEscapeUtils.escapeJson(input));
    }
